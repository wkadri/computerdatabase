...
class ComputerDatabaseSimulation extends Simulation {
  ...
  val users = scenario("Users").exec(Add.add, Edit.edit,Delete.delete)
//Search.search,Browse.browse, Add.add, Edit.edit, Delete.delete,Add.add,Edit.edit, Delete.delete
  setUp(
